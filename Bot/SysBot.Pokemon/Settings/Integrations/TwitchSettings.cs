...
public class TwitchSettings
{
    ...
    [Category(Operation), Description("How many attempts to reconnect when connection to Twitch is lost.")]
    public double ReconnectAttempts { get; set; } = 10;
    ...
    [Category(Operation), Description("Use 3 digit numbers as trade code in place of Pokemon names for LGPE.")]
    public bool UseDigitCode { get; set; } = false;
