...
public class TimingSettings
{
    ...
    [Category(Misc), Description("Extra time in milliseconds to wait for Distribution Countdown before Distributions trades.")]
    public int LGPEDistributionDelay { get; set; }
