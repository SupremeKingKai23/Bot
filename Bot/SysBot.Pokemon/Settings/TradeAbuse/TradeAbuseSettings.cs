...
namespace SysBot.Pokemon
{
    public class TradeAbuseSettings
    {
        ...
        [Category(Monitoring), Description("When a person appears again in less than this setting's value (minutes), a notification will be sent.")]
        public double DistributionCooldown { get; set; }
        ...
        [Category(Monitoring), Description("When a person is encountered with a banned ID, block them in-game before quitting the trade. SWSH Only")]
