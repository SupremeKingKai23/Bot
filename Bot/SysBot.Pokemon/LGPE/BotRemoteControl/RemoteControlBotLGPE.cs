...
{
    public class RemoteControlBotLGPE : PokeRoutineExecutor7LGPE
    {
        public RemoteControlBotLGPE(PokeBotState cfg) : base(cfg)
        {
        }
        ...
        public override async Task MainLoop(CancellationToken token)
        {
            ...
            Log($"Ending {nameof(RemoteControlBotLGPE)} loop.");
