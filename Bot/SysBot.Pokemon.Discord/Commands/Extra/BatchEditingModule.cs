...
public class BatchEditingModule : ModuleBase<SocketCommandContext>
{
    ...
    public async Task GetBatchInfo([Summary("Batch Editor Property Name")] string propertyName)
    {
    ...
    [Summary("Tries to get info about the requested property.")]
    public async Task ValidateBatchInfo([Summary("Batch Editor Instructions")] string instructions)
    {
